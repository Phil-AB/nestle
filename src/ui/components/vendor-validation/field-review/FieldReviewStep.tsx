...
import { Loader, Save, ClipboardCheck, AlertCircle, FileText } from "lucide-react"
import { DocumentFieldPanel } from "./DocumentFieldPanel"
import { DocumentViewer } from "../shared/DocumentViewer"
import { TabBar } from "../shared/TabBar"
import type { DocFiles, ExtractedDocumentMeta, FieldEdits, LineItemEdits, TableEdits } from "../lib/types"

type FieldReviewView = "fields" | "documents"
...
export function FieldReviewStep({
  ...
  const [view, setView] = useState<FieldReviewView>("fields")
  ...
  return (
    <div className="space-y-4">
      ...
      <TabBar
        tabs={[
          { v: "fields" as const, label: "Extracted Fields", icon: ClipboardCheck },
          { v: "documents" as const, label: "Source Documents", icon: FileText, count: uploadedDocs.length },
        ]}
        active={view}
        onChange={(v) => {
          setView(v)
